...
int main() {
    std::vector<int> numStudents = {1000, 10000, 100000, 1000000, 10000000};
    int numTests = 5;

    for (int num : numStudents) {
        std::string fileName = "kursiokai" + std::to_string(num) + ".txt";
        std::cout << num << " studentu spartos analize:" << "\n";
        ...
        for (int j = 0; j < numTests; ++j) {
            ...
            generateAndSaveStudents(num, fileName, fileCreateDuration);
